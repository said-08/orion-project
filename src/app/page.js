...
export default function Home() {
  return (
    <>
      ...
      />
      <div className="fixed top-4 left-4 animate-slide-from-top z-50">
        <div className="bg-white/20 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 px-6 py-4">
